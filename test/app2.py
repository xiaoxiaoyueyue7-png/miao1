...
if st.session_state.page == "home":
    ...
    <style>
        ...
        .mini-card {{ position: absolute; width: 110px; height: 180px; background-image: url("data:image/jpeg;base64,{card_back_base64}"); background-size: cover; border-radius: 8px; border: 2px solid white; box-shadow: 0 4px 10px rgba(0,0,0,0.3); }}
        ...
        .spread-card {{ width: 120px; height: 200px; background-image: url("data:image/jpeg;base64,{card_back_base64}"); background-size: cover; background-position: center; border-radius: 8px; border: 2px solid #D4AF37; box-shadow: 2px 4px 8px rgba(0,0,0,0.2); transition: transform 0.3s ease; }}
...
# --- 喵咪树洞 ---
    ...
    for msg in st.session_state.messages:
        ...
        <div class="msg-row {role}">
            <img src="data:image/jpeg;base64,{head}" class="avatar">
